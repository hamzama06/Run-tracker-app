package com.maouni92.runtracker.services
...
import com.maouni92.runtracker.helper.Constants.FASTEST_LOCATION_INTERVAL
import com.maouni92.runtracker.helper.Constants.LOCATION_UPDATE_INTERVAL
import com.maouni92.runtracker.helper.Constants.NOTIFICATION_ID
    ...
    private fun addPathPoint(location: Location?) {
        location?.let {
            ...
            pathPoints.value?.apply {
                ...
                Log.d("Service", "///////// new location : ${location.latitude} , ${location.longitude}")
            }
        }
    }
        ...
        timeRunInSeconds.observe(this, Observer {time->
            if (!isServiceDestroyed){
                val notification = currentNotificationBuilder
                    .setContentText((time*1000L).getFormattedTime())
